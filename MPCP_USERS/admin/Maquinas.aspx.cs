...
namespace MPCP_USERS.admin
{
    public partial class Maquinas : System.Web.UI.Page
    {
        ...
        public void buscaMaquina(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(ConfigurationManager.ConnectionStrings["SQLconection2"].ToString()))
            {
                ...
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT NUMERO_MAQ, NOMBRE_MAQ, AREA, UBICACION, TIPO_MAQ FROM CAT_MAQUINAS WHERE AREA= '"+selectArea.SelectedValue+"'", sqlCon);
                sqlDa.Fill(dtbl);
