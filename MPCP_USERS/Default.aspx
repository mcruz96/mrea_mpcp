<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MPCP_USERS.Default" %>
			...
			<div class="tab-content">
				<div class="tab-pane" id="login">
							...
							<div class="form-group">								
								 <asp:TextBox runat="server" type="text" name="txtUsuario" id="txtUsuarioSop" placeholder="Usuario" class="form-control" autocomplete="off" value="usr2"/>
               
								</div>

								<div class="form-group">								
								 <asp:TextBox runat="server" type="password" name="txtUsuario" id="txtPass" placeholder="Contraseña" class="form-control" autocomplete="off" value="pass123"/>
