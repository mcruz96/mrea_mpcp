...
namespace MPCP_USERS.user
{
    public partial class reportes : System.Web.UI.Page
    {
        ...
        public void concernsAbiertos()
        {
            ...
            if (fec == false)
            {
                query = "SELECT CONVERT(varchar,FECHA_FALLA,103) as FECHA_FALLA , NUM_CONCERN, ID, NOMBRE_OPERADOR, AREA_SOPORTE, RIGHT( CONVERT(DATETIME, HORA_FALLA, 108),8) as HORA_FALLA, DEPARTAMENTO, NUM_PARTE, LINEA, NUMERO_MAQ, COORDINADOR, PROBLEMA FROM REPORT_CONCERN WHERE STATUS = 'A' ORDER BY ID";
            ...
            if (fec == true)
            {
                query = "SELECT CONVERT(varchar,FECHA_FALLA,103) as FECHA_FALLA , NUM_CONCERN, ID, NOMBRE_OPERADOR, AREA_SOPORTE, RIGHT( CONVERT(DATETIME, HORA_FALLA, 108),8) as HORA_FALLA, DEPARTAMENTO, NUM_PARTE, LINEA, NUMERO_MAQ, COORDINADOR, PROBLEMA FROM REPORT_CONCERN WHERE STATUS = 'A' AND (FECHA_FALLA BETWEEN '" + fec1 + "' AND '" + fec2 + "') ORDER BY ID ";
            }
        ...
        public void concernsCerrados()
        {
            ...
            if (fec == false)
            {
                query = "SELECT HORA_ATENCION, RESPONSABLE, FECHA_CIERRE, HORA_CIERRE, TIEMPO_ATENCION, CAUSA_RAIZ, ACCIONES, TIEMPO_MUERTO, COMENT, CIERRE_MPCP FROM REPORT_CONCERN WHERE STATUS = 'C' ORDER BY ID";
            ...
            if (fec == true)
            {
                query = "SELECT HORA_ATENCION, RESPONSABLE, FECHA_CIERRE, HORA_CIERRE, TIEMPO_ATENCION, CAUSA_RAIZ, ACCIONES, TIEMPO_MUERTO, COMENT, CIERRE_MPCP  WHERE STATUS = 'C' AND (FECHA_FALLA BETWEEN '" + fec1 + "' AND '" + fec2 + "') ORDER  BY ID ";
            }
        ...
        public void concernTodos()
        {
            ...
            if (fec == false)
            {
                query = "SELECT CONVERT(varchar,FECHA_FALLA,103) as FECHA_FALLA , NUM_CONCERN, ID, NOMBRE_OPERADOR, AREA_SOPORTE, RIGHT( CONVERT(DATETIME, HORA_FALLA, 108),8) as HORA_FALLA, DEPARTAMENTO, NUM_PARTE, LINEA, NUMERO_MAQ, COORDINADOR, PROBLEMA, HORA_ATENCION, RESPONSABLE, FECHA_CIERRE, HORA_CIERRE, TIEMPO_ATENCION, CAUSA_RAIZ, ACCIONES, TIEMPO_MUERTO, COMENT, CIERRE_MPCP FROM REPORT_CONCERN ORDER BY ID";
            ...
            if (fec == true)
            {
                query = "SELECT CONVERT(varchar,FECHA_FALLA,103) as FECHA_FALLA , NUM_CONCERN, ID, NOMBRE_OPERADOR, AREA_SOPORTE, RIGHT( CONVERT(DATETIME, HORA_FALLA, 108),8) as HORA_FALLA, DEPARTAMENTO, NUM_PARTE, LINEA, NUMERO_MAQ, COORDINADOR, PROBLEMA, HORA_ATENCION, RESPONSABLE, FECHA_CIERRE, HORA_CIERRE, TIEMPO_ATENCION, CAUSA_RAIZ, ACCIONES, TIEMPO_MUERTO, COMENT, CIERRE_MPCP FROM REPORT_CONCERN WHERE FECHA_FALLA BETWEEN '" + fec1 + "' AND '" + fec2 + "' ORDER BY ID";
            }
