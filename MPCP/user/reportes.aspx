<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportes.aspx.cs" Inherits="MPCP.user.reportes" %>
   ...
   <img class="responsive-img" id="logoMrea" src="../images/logo.png">
    ...
    <li><a href="CONCERNS.aspx" runat="server"><i class="material-icons">timeline</i>Seguimiento</a></li>
     <li><a href="abrirConcern.aspx"><i class="material-icons">add_circle_outline</i>Asignar Concern</a></li>      
      <li><a href="cerrarConcern.aspx" runat="server"><i class="material-icons">lock_outline</i>Cerrar Concern</a></li>
      ...
      <div class="container">
          ...
          <div class="row">
               <div class="col s12">
                   ...
                   <div class="col s6" style="margin-top:10%;">
                    


                       <div class="col s9">
                                   <div class="input-field" id="selectAreaa"> 
                              <i class="material-icons prefix">search</i>    
                                
                                     <asp:DropDownList ID="selectArea" runat="server" OnSelectedIndexChanged="selectArea_SelectedIndexChanged" AutoPostBack="true">           
           
                                    </asp:DropDownList>
                                <label for="selectConcern">Área</label>
			...
			<div class="checkbox">
				...
				<input type="checkbox" name="checkboxArea" id="checkboxArea" runat="server">
				<label for="checkboxArea" id="lblArea" runat="server">Todas</label>
          ...
          <div class="row">
			...
			<div class="checkbox">
				...
				<input type="checkbox" name="checkboxMaq" id="CheckboxMaq" runat="server" >
				<label for="CheckboxMaq" id="lblMaq" runat="server">Por máquina</label>
                      ...
                      <div class="col s5">                                
                                     ...
                                     <asp:DropDownList ID="selectMaquina" runat="server" class=" browser-default" >           
